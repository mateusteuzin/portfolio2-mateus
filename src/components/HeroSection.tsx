      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold leading-[1.05] tracking-tight text-foreground">
            Mateus |{" "}
            <span className="text-primary">Gestão de Tecnologia da Informação.</span>
          </h1>

          {/* Subtext */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-[65ch] leading-relaxed">
            Acadêmico de GTI focado em transformar dados complexos em inteligência de negócio,
            otimizando sistemas e processos através de SQL, Power BI e Excel.
          </p>
